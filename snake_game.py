...
class cube(object):
    rows = 20
    w = 500
    def __init__(self,start,dirnx=1,dirny=0,color=(255, 106, 0)):
        self.pos = start
        self.dirnx = 1
        self.dirny = 0
        self.color = color
...
def main():
    ...
    s = snake((255, 106, 0), (10,10))
    snack = cube(rand_Snack(rows, s), color=(0,255,0))
    flag = True
    ...
    while flag:
        ...
        for x in range(len(s.body)):
            if s.body[x].pos in list(map(lambda z:z.pos,s.body[x+1:])):
                ...
                message_box('You Loss!!!', 'Play again...')
                s.reset((10,10))
                break
